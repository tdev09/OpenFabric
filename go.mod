module github.com/openfabric/openfabric
...
// Exclude the split-module version of go-libp2p/core to resolve ambiguous import errors.
// In v0.36.x, core is embedded in the main go-libp2p module.
exclude github.com/libp2p/go-libp2p/core v0.43.0-rc2

replace github.com/google/renameio => ./internal/renameio
